  ...
  resubscriptions = {
      authorized: {
          ...
          proposal_open_contract: (): void => {
              ...
              this.getInState('contracts').forEach(id =>
                  this.subscribeToOpenContract(id)
              );
          },
      },
      unauthorized: {
          tick: (): void => {
              ...
              this.getInState('ticksHistory').forEach((param, symbol) =>
                  this.getTickHistory(symbol, param)
              );
          },
          ohlc: (): void => {
              this.getInState('candlesHistory').forEach((param, symbol) =>
                  this.getTickHistory(symbol, param)
              );
          },
          proposal: (): void => {
              this.getInState('proposals').forEach(proposal =>
